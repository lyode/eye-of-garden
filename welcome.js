...
(() => {
  ...
  const copy = {
    en: {
      ...
      eyebrow:'A little space, just for you',hero:'For every step<br>of your journey.',intro:'A gentle place for people living with movement-related conditions, and the families and partners beside them.',enter:'Step into My Room',explore:'Explore the garden',pace:'Come as you are. Go at your own pace.',photo:'There is room for you<br>to grow here.',welcome:'You belong here.',belong:'For yourself. For someone you love. For the days in between.',start:'What feels right today?',startSub:'A small moment is a good place to begin.',
    ...
    zh: {
      ...
      eyebrow:'给自己，一点小小的空间',hero:'陪伴你旅程中的<br>每一步。',intro:'为有运动相关状况的人，以及陪伴他们的家人和伴侣，留一处温柔的空间。',enter:'走进我的空间',explore:'逛逛花园',pace:'做你自己。按自己的节奏来。',photo:'在这里，<br>有属于你的成长空间。',welcome:'这里欢迎你。',belong:'为了自己。为了所爱的人。为了每一个平凡的日子。',start:'今天，你想做些什么？',startSub:'从一个小小的片刻开始，就很好。',
